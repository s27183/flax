...
"""Test policy by playing a full Atari game using NNX."""
...
def policy_test(
  ...
  """Perform a test of the policy in Atari environment using NNX.

  Args:
    n_episodes: number of full Atari episodes to test on
    model: the actor-critic model (NNX module with embedded parameters)
